...
// test
const p1 = new Mypromise((resolve) => setTimeout(resolve.bind(null, "resolved"), 3000));
p1.then(console.log).then((...args) => console.log("second", ...args));

const p2 = new Mypromise((resolve, reject) => setTimeout(reject.bind(null, "rejected"), 3000));
