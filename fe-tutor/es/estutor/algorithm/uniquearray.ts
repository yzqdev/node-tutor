...
const newarr = [1, 1, `true`, `true`, `a`, `a`, true, true, false, false, undefined, undefined, null, null, NaN, NaN, `NaN`, `NaN`, 0, 0, {}, {}, [], []];
...
//filter方法
let uniquefiltersimp = (arr) => arr.filter((item, index, arr) => arr.indexOf(item) === index);
